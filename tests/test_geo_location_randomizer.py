...
class TestGeoLocationRandomizer(unittest.TestCase):
    ...
    def test_location_within_range(self):
        ...
        for _ in range(self.repeat_count):
            lat, lon = GeoLocationRandomizer.generate_random_location(NL_LAT_LONG_BOUNDARY[0], NL_LAT_LONG_BOUNDARY[1])
    ...
    def test_location_outside_range_of_nl(self):
        for _ in range(self.repeat_count):
            lat, lon = GeoLocationRandomizer.generate_random_location((8.09008, 34.55765), (68.82655, 96.12882))
